...
namespace hospitalapp
{
    public partial class opfrm : UserControl
    {
        ...
        public opfrm()
        {
            ...
            dataGridView1.DataSource = db.GetTable("SELECT op.* FROM op");
        ...
        private void btnSaveRegistration_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String query="INSERT INTO op  ( name, Age, Address, Phone, Date, Time, Disease, Bloodgroup, Doctor, Remarks)VALUES ('" + txtPatiname.Text + "'," + txtAge.Text + ",'" + RtxtAddress.Text + "','" + txtphone.Text + "','" + DTP_date.Text + "','" + DTP_time.Text + "','" + txtDisease.Text + "','" + CB_Bloodgp.Text + "','" + cbDoctor.Text + "','" + Rtxt_Remark.Text + "')";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                txtPatiname.Text = dataGridView1.Rows[e.RowIndex].Cells[4].ToString();
